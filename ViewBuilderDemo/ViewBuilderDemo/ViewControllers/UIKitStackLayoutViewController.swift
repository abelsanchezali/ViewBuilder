...
public class UIKitStackLayoutViewController: UIViewController {
    ...
    @IBAction func buttonAction(_ sender: AnyObject) {
        ...
        case 0:
            ...
            button.margin = UIEdgeInsets(top:8, left:8, bottom:8, right:8)
        ...
        case 1:
            ...
            label.margin = UIEdgeInsets(top:8, left:8, bottom:8, right:8)
            label.backgroundColor = UIColor.brown.withAlphaComponent(0.5)
            stackView.addArrangedSubview(label)
        case 2:
            let toggle = UISwitch()
            toggle.margin = UIEdgeInsets(top:8, left:8, bottom:8, right:8)
    ...
    @IBAction func alignmentAction(_ sender: AnyObject) {
        ...
        if let button = sender as? UIButton {
            button.setTitle("\(stackView.alignment)", for: UIControl.State())
        }
    }
